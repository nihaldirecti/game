...
Shop.prototype = {
    ...
    create() {
        ...
        this.attackLabel = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (2 / 6) + 30, GAME_CONST.CANVAS.HEIGHT * (1 / 3) - 70, 'Attack(' + (gameInfo.rpgElements.sword_index + 1) + '/' + GAME_CONST.SWORD_DAMAGE.length + ')', {
            font: '60px Arial',
            fill: '#d38523',
            align: "center"
        });
        this.speedLabel = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (3 / 6) + 30, GAME_CONST.CANVAS.HEIGHT * (1 / 3) - 70, 'Speed(' + (gameInfo.rpgElements.x_index + 1) + '/' + GAME_CONST.VELOCITY.x.length + ')', {
            font: '60px Arial',
            fill: '#d38523',
            align: "center"
        });
        this.jumpLabel = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (4 / 6) + 30, GAME_CONST.CANVAS.HEIGHT * (1 / 3) - 70, 'Jump(' + (gameInfo.rpgElements.y_index + 1) + '/' + GAME_CONST.VELOCITY.y.length + ')', {
            font: '60px Arial',
            fill: '#d38523',
            align: "center"
        });

        this.costLabel1 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (1 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, GAME_CONST.UPGRADE_COST.HEALTH, {
            font: '30px Arial',
            fill: '#d38523',
            align: "center"
        });
        this.game.add.sprite(GAME_CONST.CANVAS.WIDTH * (1 / 6) + 140, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, 'buy-coin');
        this.costLabel2 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (2 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, '1', {
            font: '30px Arial',
            fill: '#d38523',
            align: "center"
        });
        this.game.add.sprite(GAME_CONST.CANVAS.WIDTH * (2 / 6) + 140, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, 'buy-coin');
        this.costLabel3 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (3 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, '1', {
            font: '30px Arial',
            fill: '#d38523',
            align: "center"
        });
        this.game.add.sprite(GAME_CONST.CANVAS.WIDTH * (3 / 6) + 140, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, 'buy-coin');
        this.costLabel4 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (4 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 10, '1', {
            font: '30px Arial',
            fill: '#d38523',
            align: "center"
        });
        ...
        this.buyLabel1 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (1 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 70, 'BUY', {
            font: '30px Arial',
            fill: '#000',
            align: "center"
        });
        this.buyLabel2 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (2 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 70, 'BUY', {
            font: '30px Arial',
            fill: '#000',
            align: "center"
        });
        this.buyLabel3 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (3 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 70, 'BUY', {
            font: '30px Arial',
            fill: '#000',
            align: "center"
        });
        this.buyLabel4 = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (4 / 6) + 120, GAME_CONST.CANVAS.HEIGHT * (2 / 3) + 70, 'BUY', {
            font: '30px Arial',
            fill: '#000',
            align: "center"
        });
        ...
        this.coinsLabel = this.game.add.text(GAME_CONST.CANVAS.WIDTH * (1 / 6) + 50, GAME_CONST.CANVAS.HEIGHT - 120, this.totalCoins + ' coins available', {
            font: '70px Arial',
            fill: '#d38523',
            align: "center"
        });
